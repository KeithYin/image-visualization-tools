...
def semantic_image(class_map, max_class_id=20):
    """
    return semantic image
    :param class_map: 2D int ndarray, [height, width], each cell in the array represent the
    corresponding pixel class.
    :param num_classes: int - specify the number of class
